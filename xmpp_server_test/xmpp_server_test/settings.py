"""
Django settings for xmpp_server_test project.
...
SECRET_KEY = '5(4vh=ut03tojmfj^)@7%7-l)n1h@cwx#77!y95$rm)(0gxas*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'server_test.context_processors.server_test',
            ],
        },
    },
]

WSGI_APPLICATION = 'xmpp_server_test.wsgi.application'
